...
#add the one of grp6 (from Network_role_Modules.R script)
...
tapply(obs_mod_grp$mod, obs_mod_grp$site, shapiro.test) #no normality
#Independant measures --> Friedman test
